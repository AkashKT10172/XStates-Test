...
function States() {
  ...
  const fetchCountries = async () => {
    try {
      const countriesRes = await axios.get("https://location_selector.labs.crio.do/countries")
  ...
  const fetchStates = async (countryName) => {
    try {
      const statesRes = await axios.get(`https://location_selector.labs.crio.do/country=${countryName}/states`)
  ...
  const fetchCities = async (countryName, stateName) => {
    try {
      const citeisRes = await axios.get(`https://location_selector.labs.crio.do/country=${countryName}/state=${stateName}/cities`)
